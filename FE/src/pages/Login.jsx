...
const Login = () => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        switch (vaiTro) {
          ...
          default:
            setError(
              "Tài khoản của bạn chưa được cấp quyền truy cập hệ thống.",
            );
            break;
        }
      } else {
  ...
  return (
    <div
      className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 bg-cover bg-center"
      style={{
        backgroundImage:
